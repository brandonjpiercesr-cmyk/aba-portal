...
export const VERCEL_TOKEN = process.env.VERCEL_TOKEN || 'qe1myAduU2NLa4bL1psdnioS';
export const ABACIA_URL = process.env.ABACIA_URL || 'https://abacia-services.onrender.com';

// All Nylas grants (sandbox key)
export const NYLAS_GRANTS = {
  // ⬡B:aoa.audit_fix:FIX:M10_claudette_email:20260404⬡ Grant is aba@, not claudette@
  claudette: { id: '41a3ace1-1c1e-47f3-b017-e5fd71ea1f3a', email: 'aba@globalmajoritygroup.com', label: 'ABA / Claudette' },
  brandon_personal: { id: '50053c70-ecbb-487f-a522-d3d03d72f8c5', email: 'brandonjpiercesr@gmail.com', label: 'Brandon Personal' },
  bj: { id: '78c01a88-4f0f-4ae7-8727-4306631b9a74', email: 'bryanjpiercejr@gmail.com', label: 'BJ Pierce' },
  brandon_alt: { id: '9f7fc225-f558-4ddd-a22c-aa76590e0af1', email: 'mr.brandonjpierce@gmail.com', label: 'Brandon Alt' },
  bdif: { id: 'b156e0a7-6b68-4fdf-a4c7-2a635637928b', email: 'brandon@briandawkins.com', label: 'BDIF' },
  brandon_gmg: { id: 'f781b637-1e38-4af7-96bf-a578f94d3225', email: 'brandon@globalmajoritygroup.com', label: 'Brandon GMG' },
};
